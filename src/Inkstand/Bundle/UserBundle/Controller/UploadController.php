...
class UploadController extends Controller
{
    ...
    public function uploadAction(Request $request)
    {
        ...
        if($uploadForm->isValid()) {
            ...
            try {
                $userData = $this->get('inkstand_user.user_manager')->parseUserFile($spreadsheet);
            ...
            $userErrors = $this->get('inkstand_user.user_manager')->getUsersValidationErrors($userData['users']);
